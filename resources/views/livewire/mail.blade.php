                          ...
                          <label class="px-3">
                            ...
                            <ul class="mt-6">
                                <li class="py-5 border-b px-3 transition hover:bg-indigo-100">
                                    <a href="{{ $item['id'] }}" class="flex justify-between items-center">
                                        <p class="text-light text-gray-400">Form. {{ $item['from'] }}</p>
                                        <p class="text-md text-gray-400">{{ $item['date'] }}</p>
                                    </a>
                                    <div class="text-md italic text-gray-400 mt-4 mb-0.2">{{ $item['subject'] }}</div>
                                </li>
                            </ul>
                            @endforeach
                        </section>
                            ...
                            <div class="flex justify-between items-center h-48 border-b-2 mb-8">
                                <div class="flex space-x-4 items-center">
                                    ...
                                    <div class="flex flex-col">
                                        <p class="text-light text-gray-400">Form.</p>
